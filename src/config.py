...
CHART_LABELS = {
    ...
    SHOOTING_OPPORTUNITIES_PER_90_FROM_RECEPTIONS_IN_ZONE_14_AND_17: "Shots and shot assists per 90 from receptions in zone 14 and 17",
    EXPECTED_GOALS_PER_90_FROM_RECEPTIONS_IN_ZONE_14_AND_17: "xG per 90 from receptions in zone 14 and 17",
    f"{NORMALISED}_{SHOOTING_OPPORTUNITIES_PER_90_FROM_RECEPTIONS_IN_ZONE_14_AND_17}": "Shots and shot assists per 90 from receptions in zone 14 and 17 - Normalised score",
    f"{NORMALISED}_{EXPECTED_GOALS_PER_90_FROM_RECEPTIONS_IN_ZONE_14_AND_17}": "xG per 90 from receptions in zone 14 and 17 - Normalised score",
